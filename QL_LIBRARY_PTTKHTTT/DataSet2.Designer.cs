...
namespace QL_LIBRARY_PTTKHTTT {
    ...
    public partial class DataSet2 : global::System.Data.DataSet {
        ...
        public partial class PhieuMuonDataTable : global::System.Data.TypedTableBase<PhieuMuonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PhieuMuonRow AddPhieuMuonRow(System.DateTime NgayMuon, string NgayHenTra, int SoLuongMuon, string TenDocGia, string TenSach, int SoNgayTre) {
            ...
            private void InitClass() {
                ...
                this.columnSoNgayTre.ReadOnly = true;
            }
        ...
        public partial class PhieuMuonRow : global::System.Data.DataRow {
            ...
            public int SoNgayTre {
                get {
                    try {
                        return ((int)(this[this.tablePhieuMuon.SoNgayTreColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'SoNgayTre\' in table \'PhieuMuon\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablePhieuMuon.SoNgayTreColumn] = value;
                }
            }
            ...
            public bool IsSoNgayTreNull() {
                return this.IsNull(this.tablePhieuMuon.SoNgayTreColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetSoNgayTreNull() {
                this[this.tablePhieuMuon.SoNgayTreColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace QL_LIBRARY_PTTKHTTT.DataSet2TableAdapters {
    ...
    public partial class PhieuMuonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        pm.PhieuMuonID, dg.TenDocGia, s.TenSach, pm.NgayMuon, pm.NgayHenTra, pm.SoLuongMuon, DAY(GETDATE()) - DAY(pm.NgayHenTra) AS SoNgayTre
FROM            sach AS s INNER JOIN
                         PhieuMuon AS pm ON s.SachID = pm.Sach INNER JOIN
                         docgia AS dg ON pm.DocGia = dg.DocGiaID
WHERE        (DAY(GETDATE()) - DAY(pm.NgayHenTra) >= 1)";
        ...
        public virtual int Fill(DataSet2.PhieuMuonDataTable dataTable) {
        ...
        public virtual DataSet2.PhieuMuonDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet2.PhieuMuonDataTable dataTable = new DataSet2.PhieuMuonDataTable();
