...
namespace QL_LIBRARY_PTTKHTTT {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class PhieuMuonDataTable : global::System.Data.TypedTableBase<PhieuMuonRow> {
            ...
            private global::System.Data.DataColumn columnPhieuMuonXNID;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public global::System.Data.DataColumn PhieuMuonXNIDColumn {
                get {
                    return this.columnPhieuMuonXNID;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PhieuMuonRow AddPhieuMuonRow(System.DateTime NgayMuon, int SoLuongMuon, string TenDocGia, string TenSach, System.DateTime NgayHenTra, string TinhTrang) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PhieuMuonRow FindByPhieuMuonXNID(int PhieuMuonXNID) {
            ...
            internal void InitVars() {
                ...
                this.columnPhieuMuonXNID = base.Columns["PhieuMuonXNID"];
            ...
            private void InitClass() {
                ...
                this.columnPhieuMuonXNID = new global::System.Data.DataColumn("PhieuMuonXNID", typeof(int), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnPhieuMuonXNID);
                ...
                this.columnPhieuMuonXNID.AutoIncrement = true;
                this.columnPhieuMuonXNID.AutoIncrementSeed = -1;
                this.columnPhieuMuonXNID.AutoIncrementStep = -1;
                this.columnPhieuMuonXNID.AllowDBNull = false;
                this.columnPhieuMuonXNID.ReadOnly = true;
                this.columnPhieuMuonXNID.Unique = true;
        ...
        public partial class PhieuMuonRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public int PhieuMuonXNID {
                get {
                    return ((int)(this[this.tablePhieuMuon.PhieuMuonXNIDColumn]));
                }
                set {
                    this[this.tablePhieuMuon.PhieuMuonXNIDColumn] = value;
                }
            }
...
namespace QL_LIBRARY_PTTKHTTT.DataSet1TableAdapters {
    ...
    public partial class PhieuMuonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("PhieuMuonXNID", "PhieuMuonXNID");
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        pmxn.PhieuMuonXNID, s.TenSach, dg.TenDocGia, pmxn.NgayMuon, pmxn.NgayHenTra, pmxn.SoLuongMuon, pmxn.TinhTrang
FROM            phieumuonxn AS pmxn INNER JOIN
                         sach AS s ON pmxn.Sach = s.SachID INNER JOIN
                         docgia AS dg ON pmxn.DocGia = dg.DocGiaID
WHERE        (pmxn.PhieuMuonXNID = @ID)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ID", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "PhieuMuonXNID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(DataSet1.PhieuMuonDataTable dataTable, int ID) {
        ...
        public virtual DataSet1.PhieuMuonDataTable GetData(int ID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(ID));
            DataSet1.PhieuMuonDataTable dataTable = new DataSet1.PhieuMuonDataTable();
